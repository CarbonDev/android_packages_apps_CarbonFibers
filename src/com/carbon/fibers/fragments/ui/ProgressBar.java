...
import com.carbon.fibers.fragments.ui.SpecialSeekBarPreference;
...
public class ProgressBar extends SettingsPreferenceFragment implements
    ...
    private SpecialSeekBarPreference mprogressbar_speed;
    private SpecialSeekBarPreference mprogressbar_width;
    private SpecialSeekBarPreference mprogressbar_length;
    private SpecialSeekBarPreference mprogressbar_count;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mprogressbar_speed = (SpecialSeekBarPreference) findPreference(PROGRESSBAR_SPEED);
        ...
        mprogressbar_width = (SpecialSeekBarPreference) findPreference(PROGRESSBAR_WIDTH);
        ...
        mprogressbar_length = (SpecialSeekBarPreference) findPreference(PROGRESSBAR_LENGTH);
        ...
        mprogressbar_count = (SpecialSeekBarPreference) findPreference(PROGRESSBAR_COUNT);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_RESET, 0, R.string.progressbar_button_reset)
