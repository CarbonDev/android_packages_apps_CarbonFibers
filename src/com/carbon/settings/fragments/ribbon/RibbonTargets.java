...
public class RibbonTargets extends SettingsPreferenceFragment implements
    ...
    private static final LinearLayout.LayoutParams PARAMS_TOGGLE_SCROLL =
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final String[] hideEntries =
                getResources().getStringArray(R.array.hide_navbar_timeout_entries);
        ...
        final String[] dismissEntries =
                getResources().getStringArray(R.array.ribbon_dismiss_entries);
        ...
        final String[] columnsEntries =
                getResources().getStringArray(R.array.window_columns_entries);
        ...
        mWindowColumns.setSelection(Arrays.asList(columnsValues)
        ...
        mEnableBottomSwitch
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton v, boolean checked) {
                        Settings.System
                                .putBoolean(mContentRes, Settings.System.ENABLE_RIBBON_LOCATION[0],
                                        checked);
                    }
                });
        ...
        mEnableLeftSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(mContentRes, Settings.System.ENABLE_RIBBON_LOCATION[1],
                        checked);
            }
        });
        ...
        mEnableRightSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System.putBoolean(mContentRes, Settings.System.ENABLE_RIBBON_LOCATION[2],
                        checked);
            }
        });
        ...
        mRibbonHideIme.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System
                        .putBoolean(mContentRes, Settings.System.RIBBON_HIDE_IME[ribbonNumber],
                                checked);
            }
        });
        ...
        mEnableTextSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System
                        .putBoolean(mContentRes, Settings.System.ENABLE_RIBBON_TEXT[arrayNum],
                                checked);
            }
        });
        ...
        mEnableVibSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System
                        .putBoolean(mContentRes, Settings.System.SWIPE_RIBBON_VIBRATE[ribbonNumber],
                                checked);
            }
        });
        ...
        mRibbonIconVibrate.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System
                        .putBoolean(mContentRes, Settings.System.RIBBON_ICON_VIBRATE[arrayNum],
                                checked);
            }
        });
        ...
        mButtonColorize.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton v, boolean checked) {
                Settings.System
                        .putBoolean(mContentRes, Settings.System.RIBBON_ICON_COLORIZE[arrayNum],
                                checked);
            }
        });
        ...
        final String[] iconEntries =
                getResources().getStringArray(R.array.ribbon_icon_size_entries);
        ...
        final String[] locEntries =
                getResources().getStringArray(R.array.ribbon_handle_location_entries);
    ...
    public class TimeOutListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            final String[] values =
                    getResources().getStringArray(R.array.hide_navbar_timeout_values);
            int tempHide = Integer.parseInt((String) values[pos]);
            Settings.System.putInt(mContentRes, Settings.System.RIBBON_HIDE_TIMEOUT[ribbonNumber],
                    tempHide);
        }
    ...
    public class AnimationListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            ...
            if (arrayNum < 10) {
                Settings.System
                        .putInt(mContentRes, Settings.System.RIBBON_ANIMATION_TYPE[ribbonNumber],
                                temp);
            } else {
                Settings.System
                        .putInt(mContentRes, Settings.System.APP_WINDOW_ANIMATION_TYPE, temp);
            }
        }
    ...
    public class IconSizeListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            ...
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_ICON_SIZE[arrayNum], tempSize);
        }
    ...
    public class LocationListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            final String[] values =
                    getResources().getStringArray(R.array.ribbon_handle_location_values);
            int tempLoc = Integer.parseInt((String) values[pos]);
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_LOCATION[ribbonNumber],
                            tempLoc);
        }
    ...
    public class IconLocationListener implements OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
            final String[] values =
                    getResources().getStringArray(R.array.ribbon_handle_location_values);
            int tempLoc = Integer.parseInt((String) values[pos]);
            Settings.System.putInt(mContentRes, Settings.System.RIBBON_ICON_LOCATION[ribbonNumber],
                    tempLoc);
        }
                ...
                if (arrayNum < 10) {
                    ...
                    for (int i = 0; i < mShortTargets.size(); i++) {
                        if (mShortTargets.get(i).equals("**null**")) {
                            aTargets.add(
                                    NavBarHelpers.getProperSummary(mContext, mLongTargets.get(i)));
                        } else {
                            aTargets.add(
                                    NavBarHelpers.getProperSummary(mContext, mShortTargets.get(i)));
                        }
                    }
    ...
    public void resetRibbon() {
        if (arrayNum < 10) {
            Settings.System
                    .putString(mContentRes, Settings.System.RIBBON_TARGETS_SHORT[arrayNum], "");
            Settings.System
                    .putString(mContentRes, Settings.System.RIBBON_TARGETS_LONG[arrayNum], "");
            Settings.System
                    .putBoolean(mContentRes, Settings.System.ENABLE_RIBBON_TEXT[arrayNum], true);
            ...
            Settings.System
                    .putString(mContentRes, Settings.System.RIBBON_TARGETS_ICONS[arrayNum], "");
        } else {
    ...
    public void setupButtons() {
        if (arrayNum < 10) {
            ...
            mLongTargets.clear();
            mCustomIcons.clear();
            mShortTargets = Settings.System
                    .getArrayList(mContentRes, Settings.System.RIBBON_TARGETS_SHORT[arrayNum]);
            mLongTargets = Settings.System
                    .getArrayList(mContentRes, Settings.System.RIBBON_TARGETS_LONG[arrayNum]);
            mCustomIcons = Settings.System
                    .getArrayList(mContentRes, Settings.System.RIBBON_TARGETS_ICONS[arrayNum]);

            mRibbonIconSpace.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_ICON_SPACE[arrayNum], 5));
            mRibbonAnimDur.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_ANIMATION_DURATION[ribbonNumber],
                            50));
            ...
            final String[] iconValues =
                    getResources().getStringArray(R.array.ribbon_icon_size_values);

            mIconSize.setSelection(Arrays.asList(iconValues)
                    .indexOf(String.valueOf(Settings.System.getInt(mContentRes,
            ...
            final String[] hideValues =
                    getResources().getStringArray(R.array.hide_navbar_timeout_values);

            mTimeOut.setSelection(Arrays.asList(hideValues)
                    .indexOf(String.valueOf(Settings.System.getInt(mContentRes,
                            Settings.System.RIBBON_HIDE_TIMEOUT[ribbonNumber], 5000))));

            final String[] dismissValues =
                    getResources().getStringArray(R.array.ribbon_dismiss_values);
            mRibbonDismiss.setSelection(Arrays.asList(dismissValues)
                    .indexOf(String.valueOf(Settings.System.getInt(mContentRes,
            ...
            final String[] locValues =
                    getResources().getStringArray(R.array.ribbon_handle_location_values);
            if (ribbonNumber < 2) {
                mIconLocation.setSelection(Arrays.asList(locValues)
                        .indexOf(String.valueOf(Settings.System.getInt(mContentRes,
                                Settings.System.RIBBON_ICON_LOCATION[ribbonNumber], 0))));
            }
            mLocation.setSelection(Arrays.asList(locValues).indexOf(String.valueOf(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_LOCATION[ribbonNumber],
                            0))));
            mRibbonOpacity.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.SWIPE_RIBBON_OPACITY[ribbonNumber], 100));
            mDragHandleOpacity.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_OPACITY[ribbonNumber],
                            0));
            mDragHandleWidth.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_WEIGHT[ribbonNumber],
                            30));
            mDragHandleHeight.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_HEIGHT[ribbonNumber],
                            50));
            mEnableVibSwitch.setChecked(Settings.System
                    .getBoolean(mContentRes, Settings.System.SWIPE_RIBBON_VIBRATE[ribbonNumber],
                            false));
        } else {
            updateSwitches();
            ...
            mAppWindowSpace.setProgress(
                    Settings.System.getInt(mContentRes, Settings.System.APP_WINDOW_SPACING, 5));
            mWindowOpacity.setProgress(
                    Settings.System.getInt(mContentRes, Settings.System.APP_WINDOW_OPACITY, 100));
            mWindowAnimDur.setProgress(Settings.System
                    .getInt(mContentRes, Settings.System.APP_WINDOW_ANIMATION_DURATION, 75));
            mRibbonAnimation.setSelection(mAnimations[Settings.System.getInt(mContentRes,
            ...
            if (mCustomIcons.size() > 0) {
                if (!mCustomIcons.get(i).equals("**null**")) {
                    ...
                    Drawable mIcon = NavBarHelpers.getIconImage(mContext,
                            mShortTargets.get(i).equals("**null**") ? mLongTargets.get(i) :
                                    mShortTargets.get(i));
                    ...
                    if (width > desiredSize) {
                        ...
                        if (bm != null) {
                            Bitmap bitmapOrig =
                                    Bitmap.createScaledBitmap(bm, desiredSize, desiredSize, false);
    ...
    public void cloneDialog(final String title, final String[] entries, final String[] values) {
        final DialogInterface.OnClickListener l = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                String tempShort = Settings.System
                        .getString(mContentRes, Settings.System.RIBBON_TARGETS_SHORT[tempInt]);
                String tempLong = Settings.System
                        .getString(mContentRes, Settings.System.RIBBON_TARGETS_LONG[tempInt]);
                String tempIcons = Settings.System
                        .getString(mContentRes, Settings.System.RIBBON_TARGETS_ICONS[tempInt]);
                Settings.System
                        .putString(mContentRes, Settings.System.RIBBON_TARGETS_SHORT[arrayNum],
                                tempShort);
                Settings.System
                        .putString(mContentRes, Settings.System.RIBBON_TARGETS_LONG[arrayNum],
                                tempLong);
                int tempSpace = Settings.System
                        .getInt(mContentRes, Settings.System.RIBBON_ICON_SPACE[tempInt], 5);
                Settings.System.putInt(mContentRes, Settings.System.RIBBON_ICON_SPACE[arrayNum],
                        tempSpace);
                Settings.System
                        .putString(mContentRes, Settings.System.RIBBON_TARGETS_ICONS[arrayNum],
                                tempIcons);
    ...
    private View.OnClickListener mRibbonClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            final String[] stringArray =
                    mContext.getResources().getStringArray(R.array.ribbon_dialog_entries);
            stringArray[0] =
                    stringArray[0] + "  :  " + NavBarHelpers.getProperSummary(mContext, sText);
            stringArray[1] =
                    stringArray[1] + "  :  " + NavBarHelpers.getProperSummary(mContext, lText);
            createDialog(
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        if (seekBar == mDragHandleOpacity) {
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_OPACITY[ribbonNumber],
                            progress);
        } else if (seekBar == mRibbonOpacity) {
            Settings.System.putInt(mContentRes, Settings.System.SWIPE_RIBBON_OPACITY[ribbonNumber],
                    progress);
            ...
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_WEIGHT[ribbonNumber],
                            progress);
        } else if (seekBar == mDragHandleHeight) {
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_DRAG_HANDLE_HEIGHT[ribbonNumber],
                            progress);
        } else if (seekBar == mRibbonIconSpace) {
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_ICON_SPACE[arrayNum], progress);
        } else if (seekBar == mRibbonAnimDur) {
            Settings.System
                    .putInt(mContentRes, Settings.System.RIBBON_ANIMATION_DURATION[ribbonNumber],
                            progress);
        } else if (seekBar == mWindowAnimDur) {
            Settings.System
                    .putInt(mContentRes, Settings.System.APP_WINDOW_ANIMATION_DURATION, progress);
    ...
    public class RibbonDialogReceiver extends BroadcastReceiver {
        public static final String ACTION_RIBBON_DIALOG_DISMISS =
                "com.carbon.romcontrol.ACTION_RIBBON_DIALOG_DISMISS";
