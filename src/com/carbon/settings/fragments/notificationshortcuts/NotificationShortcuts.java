...
package com.carbon.settings.fragments.notificationshortcuts;
...
import com.carbon.settings.fragments.notificationshortcuts.IconPicker;
import com.carbon.settings.fragments.notificationshortcuts.ShortcutPickHelper;
        ...
        if (Settings.System.getInt(mCr,
            ...
            for (int i=0; i < maxTargets; i++) {
                ...
                if (mTargetStore.get(i).uri.equals(EMPTY_TARGET)) {
                    pref.setTitle("<" + this.mActivity.getResources().getString(R.string.none) + ">");
                } else {
