...
public class SensorsFragmentActivity extends PreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String TAG = "DeviceTools_Sensors";
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        DeviceUtils.writeValue(FILE_PROXIMITY_KADC, (String)newValue);
        return true;
    }
    ...
    public static void restore(Context context) {
        ...
        DeviceUtils.writeValue(FILE_PROXIMITY_KADC, sharedPrefs.getString(KEY_PROXIMITY_CALIBRATION, "0x0 0xFFFF3C2D"));
    }
}
