...
public class DeviceUtils {
    ...
    private static final String TAG = "DeviceTools_Utils";
    private static final String TAG_READ = "DeviceTools_Utils_Read";
    private static final String TAG_WRITE = "DeviceTools_Utils_Write";
