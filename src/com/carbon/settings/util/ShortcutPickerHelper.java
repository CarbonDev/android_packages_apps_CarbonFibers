...
package com.carbon.settings.util;
...
public class ShortcutPickerHelper {
    ...
    private void processShortcut(Intent intent, int requestCodeApplication,
        ...
        if (bmp == null) {
            ...
            if (extra != null && extra instanceof Intent.ShortcutIconResource) {
                try {
                    ...
                    Log.w("CarbonFibers.ShortcutPicker", "Could not load shortcut icon: " + extra);
                }
            }
        }
