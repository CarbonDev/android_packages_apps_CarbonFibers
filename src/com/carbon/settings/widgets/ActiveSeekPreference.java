...
public class ActiveSeekPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String SETTINGS = "http://schemas.android.com/apk/res/com.carbon.settings";
    ...
    public ActiveSeekPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
        initPreference(context, attrs);
    }

    public ActiveSeekPreference(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected View onCreateView(ViewGroup parent){
        ...
        try {
            ...
            layout = (RelativeLayout)mInflater.inflate(R.layout.active_seek_preference, parent, false);
